...
//prazan niz
const prazanNiz=
conzole.log('prazanNiz', prazan niz)
...
//prvi element niza na indexu
console.log('Prvi element niza', temp[0])

//zadnji element niza
console.log('Zadnji element niza', temp[temp.lenght-1])
...
//u ozbiljno dev svijetu naiđe se da nizovi imaju elemente istog tipa
...
const [e1, e2] = niz // izvršio sam destrukciju na način da je 1. element  niza završio u varijabli e1, 2. u e2, niz je ostao kakav je bio
...
//npr. backen vrati prazan niz
niz.lenght=0 // na ovaj način sam očistio niz
const[x1 = 1, x2 = 20] = niz //kod destrukcije se varijablama može dodati zadana vrijednost ako
console.log(x1, x2)
