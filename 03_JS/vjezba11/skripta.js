...
// u ttijelu nema return, ova je tipa void
function odradi(){
 ...
 * Ako nije poslan niti jedan parametarndaje slučajni broj od 0 do 1
 * @param {*} odBroja 
 * @param {*} doBroja 
 * @returns slučajni broj
 */
function slucajniBroj(odBroja=0, doBroja=0){ // () znači da ne prima parametre, = daje zadanu vrijednost
if(odBroja && doBroja){
...
// varijabli sb dodijeljujem rezultat izvođenja funkcije slucajniBroj
...
log(zbrojPrimBrojeva(100,200))

const ime = 'pero'

// slučaj 4
log(ime.charCodeAt(0)) // ASCII

// slučaj 3 
log.apply(ime.toUpperCase())
...
// potrebno ; prije, to je IIFE - detaljnije čitati
;(()=>{
